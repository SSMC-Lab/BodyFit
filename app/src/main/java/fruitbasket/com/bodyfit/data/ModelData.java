...
>>>>>>> 6f1970c897ce4ca93b582ad6cdce9629ef39a1f7
    ...
    public double[][] getAx_mol(){  return ax_mol;  }
    public double[][] getAy_mol(){  return ay_mol;  }
    public double[][] getAz_mol(){  return az_mol;  }
    public double[][] getGx_mol(){  return gx_mol;  }
    public double[][] getGy_mol(){  return gy_mol;  }
    public double[][] getGz_mol(){  return gz_mol;  }
    public double[][] getMx_mol(){  return mx_mol;  }
    public double[][] getMy_mol(){  return my_mol;  }
    public double[][] getMz_mol(){  return mz_mol;  }
    public double[][] getP1_mol(){  return p1_mol;  }
    public double[][] getP2_mol(){  return p2_mol;  }
    public double[][] getP3_mol(){  return p3_mol;  }
}
